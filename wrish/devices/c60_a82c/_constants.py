...
# Sent by the bracelet to the phone on FF01 when the user triggers "find phone".
# Sniffed: 90 08 00 00 00 00 00 01 00 00 00 c0  (12 bytes observed; match as prefix)
